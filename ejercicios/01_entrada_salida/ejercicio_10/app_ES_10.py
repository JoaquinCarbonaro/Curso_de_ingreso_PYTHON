...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        importe_float = float(self.txt_importe.get())
        descuento_float = float(self.txt_descuento.get())
        descuento_pesos = importe_float * descuento_float / 100
        importe_resultante = importe_float - descuento_pesos
        alert(title="Ejercicio 10",message="El nuevo importe es " + str(importe_resultante))
